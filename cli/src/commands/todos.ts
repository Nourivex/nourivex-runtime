...
export async function todosCommand(options: TodosOptions) {
...
async function listTodos(activePath: string, cwd: string): Promise<void> {
...
async function showTodoList(cwd: string, id: string): Promise<void> {
...
function displayTodoList(todo: any, verbose: boolean): void {
  ...
  if (pending.length > 0) {
    ...
    pending.slice(0, showCount).forEach((item: any) => {
...
async function showProgress(activePath: string, cwd: string): Promise<void> {
