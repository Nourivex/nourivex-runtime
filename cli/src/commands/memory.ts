...
async function listMemory(index: MemoryIndex): Promise<void> {
...
async function searchMemory(index: MemoryIndex, query: string, cwd: string): Promise<void> {
  console.log(chalk.blue.bold(`\n🔍 Memory Search: "${query}"\n`));
...
async function showMemory(index: MemoryIndex, id: string, cwd: string): Promise<void> {
...
async function pruneMemory(index: MemoryIndex, indexPath: string, cwd: string): Promise<void> {
  console.log(chalk.blue.bold('\n🗑️  Memory Prune\n'));
