...
def _skill_target_dir() -> Path:
    return Path.home() / ".claude" / "skills" / "nourivex-docx"
...
def run_server() -> None:
    ...
    from nourivex_docx.server import main as server_main
...
def main() -> None:
    ...
    print("Usage: nourivex-docx-server [install-skill | update-skill]", file=sys.stderr)
    raise SystemExit(1)
